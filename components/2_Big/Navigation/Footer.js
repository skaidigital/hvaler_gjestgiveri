  ...
  return (
    <footer className="bg-secondary_700">
      <SectionNav
        ...
        c="border-1 border-b border-neutral_200 bg-secondary_700"
      >
        <Layout>
          <Grid c=" text-white">
            <FourSixFour>
            ...
            <TwoFourTwo>
              ...
              <div className="flex flex-col">
                ...
                <FooterLink href="/kurs-og-konferanser">
                  Kurs & Konferanser
                </FooterLink>
                <FooterLink href="/selskap">Selskap</FooterLink>
                <FooterLink href="/andre-arrangement">
                  Andre arrangement
                </FooterLink>
              </div>
            </TwoFourTwo>
      ...
      <Layout>
        <div className="py-8 flex">
          <a
            ...
            className="text-white underline border-r-1 border-white"
            target="blank"
          >
            Nettside utviklet av Skai Digital
            <span className="mx-8 text-neutral_50 opacity-[33%]">|</span>
          </a>
